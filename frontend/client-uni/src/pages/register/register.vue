...
type PaymentInfo = { accountName?: string; bankName?: string; accountNo?: string; qrCodeText?: string; wechatQrImage?: string; alipayQrImage?: string }
...
const openPaymentModal=async(order:PaymentOrder)=>{Object.assign(paymentOrder,order);selectedPaymentMethod.value='';showQrFallback.value=false;nativePaymentLoading.value=false;paymentMessage.value='';paymentCodeUrl.value='';paymentModalOpen.value=true;try{Object.assign(paymentInfo,await api.paymentInfo())}catch{}}
