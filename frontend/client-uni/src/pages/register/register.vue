...
.modal-mask{position:fixed;inset:0;z-index:90;z-index:var(--client-business-modal-layer, 90);display:flex;align-items:flex-end;justify-content:center;background:rgba(12,31,65,.48)}
