...
const logout = async () => { if (await confirmAction('确认退出登录', '退出后需要重新登录才能继续使用，确定退出吗？')) useAuthStore().logout() }
onShow(load)
</script>
