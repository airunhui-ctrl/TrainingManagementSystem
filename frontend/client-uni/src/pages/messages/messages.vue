...
.modal-mask { position: fixed; inset: 0; z-index: 90; z-index: var(--client-business-modal-layer, 90); display: flex; align-items: flex-end; justify-content: center; background: rgba(12,31,65,.48); }.modal-card { box-sizing: border-box; width: 100%; max-height: 88vh; overflow-y: auto; padding: 30rpx 28rpx calc(30rpx + env(safe-area-inset-bottom)); border-radius: 28rpx 28rpx 0 0; background: #fff; }.modal-head { display: flex; align-items: flex-start; justify-content: space-between; }.modal-title, .modal-subtitle { display: block; }.modal-title { max-width: 600rpx; color: $navy; font-size: 32rpx; font-weight: 900; }.modal-subtitle { margin-top: 8rpx; color: $muted; font-size: 20rpx; }.close { color: #8391a3; font-size: 44rpx; line-height: 1; }.detail-content { display: block; margin-top: 28rpx; color: #334a68; font-size: 25rpx; line-height: 1.8; white-space: pre-wrap; }.primary-btn { width: 100%; height: 82rpx; margin-top: 30rpx; border: 0; border-radius: 999rpx; color: #17366d; background: $yellow; font-size: 25rpx; line-height: 82rpx; font-weight: 900; }.primary-btn::after { border: 0; }
