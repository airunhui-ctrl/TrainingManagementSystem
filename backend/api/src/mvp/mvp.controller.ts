...
export class MvpController {
  ...
  @UseGuards(JwtGuard, AdminGuard)
  @Get('admin/enrollments') async enrollments() { return { items: await this.mvp.listEnrollments() } }
  @UseGuards(JwtGuard, AdminGuard)
  ...
  @UseGuards(JwtGuard, AdminGuard)
  @Get('admin/students') async students() { return { items: await this.mvp.listStudents() } }
  @UseGuards(JwtGuard, AdminGuard)
